 ...
 * {@code model/RegistroAuditoria} nunca conoce Jackson ni ninguna otra librería de
 * serialización (constitution.md §2: {@code Model} no conoce a {@code Service}, tampoco al
 * revés más allá de recibir tipos simples).
 */
@Service
public class AuditoriaServiceImpl implements AuditoriaService {
    ...
    public void registrar(
        ...
        String jsonAntes = valoresAntes == null ? null : objectMapper.writeValueAsString(valoresAntes);
        String jsonDespues = objectMapper.writeValueAsString(valoresDespues);

        RegistroAuditoria registro =
                RegistroAuditoria.registrar(actorId, accion, entidadAfectada, entidadId, jsonAntes, jsonDespues);
